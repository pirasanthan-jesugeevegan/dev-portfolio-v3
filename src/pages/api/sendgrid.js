...
async function sendEmail(req, res) {
  ...
  try {
    await sendgrid.send({
      to: 'pirasanth23@hotmail.com', // Your email where you'll receive emails
      from: 'jesugeevegan@gmail.com', // your website email address here
      subject: `[Lead from website] : Pirasanth.com`,
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <h3>You've got a new comment from ${req.body.name}, their email is: ✉️${req.body.email} </h3>
              <div style="font-size: 16px;">
              <p>Message:</p>
              <p>${req.body.comment}</p>
              <br>
              <h4><a href="https://pirasanth-blog.sanity.studio/desk/comment">Click here to Approve it</a></h4>
              </div>
